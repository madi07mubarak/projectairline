...
public class Journeydetails extends JFrame{  //Forth
	...
	String[] items1 =  {"ALMATY", "SEMEI", "ATYRAU", "KARAGANDA","NUR-SULTAN","ORAL"};
	JComboBox comboBox = new JComboBox(items1);
	comboBox.setBounds(150, 100, 150, 27);
	add(comboBox);
		
		
	String[] items2 =  {"ALMATY","SEMEI","ATYRAU", "KARAGANDA","NUR-SULTAN","ORAL"};
