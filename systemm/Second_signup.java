...
public class Second_signup extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            if(t2.getText().equals("")){
                ...
                new third_signup(formno).setVisible(true);
                setVisible(false);
            }
    ...
    public static void main(String[] args){
        new Second_signup("").setVisible(true);
    }
}
